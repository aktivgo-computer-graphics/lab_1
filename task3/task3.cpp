...
int main()
{
    ...
    if (is_intersect(a, b, c, d)) {
        std::cout << "Vectors AC and BD ARE intersect" << std::endl;
    }
    else {
...
bool is_intersect(Point a, Point b, Point c, Point d) {
    return is_convex_quadrilateral(a, b, c, d);
}
